...
@ApiBearerAuth()
@ApiUnauthorizedResponse({
  description: 'Returns HTTP-Status 401 if no Bearer token is provided',
})
@Controller({ path: 'flight', version: '2' })
...
export class FlightController {
  ...
  @ApiOkResponse({
    description: 'Returns an array of flights depending on query params',
    isArray: true,
    type: FlightServer,
  })
  @Get()
