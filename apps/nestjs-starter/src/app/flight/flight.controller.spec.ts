...
describe('Flight Controller', () => {
  const MOCK_TOKEN =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTU0MDAwMDAwfQ.1aXg5qBdE0riDCNnY-0wVydW72MNKIQuVio7DLbVj7E';
  ...
  it('should return an empty array for GET "/flight"', () => {
    jest.spyOn(flightService, 'getFlights').mockResolvedValue([]);
  ...
  it('should return correct flights for GET "/flight?from=Hamburg&to=Graz"', () => {
    ...
    jest.spyOn(flightService, 'getFlights').mockResolvedValue(mockFlights);
    return request(app.getHttpServer())
  ...
  it('should return correct flight for GET "/flight/3', () => {
    jest.spyOn(flightService, 'getFlightById').mockResolvedValue({
      id: 3,
      from: 'Hamburg',
      to: 'Graz',
      date: '2019-02-22T07:07:54.1624336+00:00',
