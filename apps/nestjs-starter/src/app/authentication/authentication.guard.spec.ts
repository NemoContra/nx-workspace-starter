...
describe('AuthenticationGuard', () => {
  ...
  it('should return HTTP-Status 200', () => {
    return request(app.getHttpServer())
      ...
      .set(
        'authorization',
        'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTU0MDAwMDAwfQ.1aXg5qBdE0riDCNnY-0wVydW72MNKIQuVio7DLbVj7E'
      )
      .expect(200)
      .expect('success!');
  });
